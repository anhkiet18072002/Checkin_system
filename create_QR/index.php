...
<body>
  <div class="container">
    <form id="contact" action="mail.php" method="post">
      ...
      <fieldset>
        <input placeholder="Your name" name="fullname" type="text" tabindex="1" autofocus>
      </fieldset>
      <fieldset>
        <input placeholder="Your Email Address" name="email" type="email" tabindex="2">
      </fieldset>
      <fieldset class="mulchoice">
        <div class="choice">
      ...
      <fieldset>
        <button type="submit" name="btn-reg" id="contact-submit">Submit Now</button>
      </fieldset>
    </form>
  </div>
</body>
